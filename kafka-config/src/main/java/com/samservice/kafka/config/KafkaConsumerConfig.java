package com.samservice.kafka.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, MessageRequest> consumerFactory(){
        JsonDeserializer<MessageRequest> jsonDeserializer = new JsonDeserializer<>();
    ...
    public KafkaListenerContainerFactory<
            ConcurrentMessageListenerContainer<String, MessageRequest>> kafkaListenerContainerFactory(ConsumerFactory<String, MessageRequest> consumerFactory){
